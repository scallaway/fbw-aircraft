...
class A2Cell extends DisplayComponent<{ bus: ArincEventBus }> {
    ...
    render(): VNode {
        return (
            <text ref={this.autoBrkRef} className={this.className} x="16.782249" y="14.329653" style="white-space: pre">{this.text}</text>
        );
    }
}
...
class A1A2Cell extends ShowForSecondsComponent<CellProps> {
    ...
    render(): VNode {
        return (
            <>
                <path ref={this.modeChangedPathRef} visibility="hidden" className="NormalStroke White" d="m0.70556 1.8143h30.927v6.0476h-30.927z" />
                <g ref={this.cellRef} />
            </>
        );
    }
...
class A3Cell extends DisplayComponent<A3CellProps> {
    ...
    render(): VNode {
        return (
            <text className={this.classSub} x="16.989958" y="21.641243">{this.textSub}</text>
        );
    }
}
...
class AB3Cell extends DisplayComponent<CellProps> {
    ...
    render(): VNode {
        return (
            <text className="FontMedium MiddleAlign Cyan" x="35.434673" y="21.656223">{this.textSub}</text>
        );
    }
}
    ...
    render(): VNode {
        return (
            <g>
                ...
                <path ref={this.modeChangedPathRef} className={this.boxClassSub} visibility="hidden" d={this.boxPathStringSub} />

                <path ref={this.speedProtectionPathRef} className="NormalStroke Amber BlinkInfinite" d="m34.656 1.8143h29.918v6.0476h-29.918z" />
                <path ref={this.inModeReversionPathRef} className="NormalStroke White BlinkInfinite" d="m34.656 1.8143h29.918v6.0476h-29.918z" />

                <text ref={this.fmaTextRef} style="white-space: pre" className="FontMedium MiddleAlign Green" x="49.921795" y="7.1040988">
...
class B2Cell extends DisplayComponent<CellProps> {
    ...
    render(): VNode {
        return (
            <g>
                <text className={this.classSub} x="41.477474" y="14.329653">{this.text1Sub}</text>
                <text className="FontMedium MiddleAlign Cyan" x="54.59803" y="14.382949">{this.text2Sub}</text>
            </g>
        );
    }
}
...
class C1Cell extends ShowForSecondsComponent<CellProps> {
    ...
    render(): VNode {
        ...
        return (
            <g>
                <path ref={this.modeChangedPathRef} className="NormalStroke White" visibility="hidden" d="m100.87 1.8143v6.0476h-33.075l1e-6 -6.0476z" />
                <text className="FontMedium MiddleAlign Green" x="84.856567" y="6.9873109">{this.textSub}</text>
            </g>
        );
    }
}
...
class C2Cell extends DisplayComponent<CellProps> {
    ...
    render(): VNode {
        return (
            <text className="FontMedium MiddleAlign Cyan" x="84.734184" y="14.440415">{this.textSub}</text>
        );
    }
}
...
class BC1Cell extends ShowForSecondsComponent<CellProps> {
    ...
    render(): VNode {
        return (
            <g>
                <path ref={this.modeChangedPathRef} className="NormalStroke White" visibility="hidden" d="m50.178 1.8143h35.174v6.0476h-35.174z" />
                <text className="FontMedium MiddleAlign Green" x="67.9795" y="6.8893085">{this.textSub}</text>
            </g>
        );
    }
}
...
class BC3Cell extends DisplayComponent<{ isAttExcessive: Subscribable<boolean>, bus: ArincEventBus, }> {
    ...
    render(): VNode {
        return (
            <text ref={this.bc3Cell} className={this.classNameSub} x="68.087875" y="21.627102" style="white-space: pre" />
        );
    }
}
...
class D1D2Cell extends ShowForSecondsComponent<CellProps> {
    ...
    render(): VNode {
        return (
            <g>
                <text className="FontMedium MiddleAlign White" x="118.45866" y="7.125926">{this.text1Sub}</text>
                <text className="FontMedium MiddleAlign White" x="118.39752" y="14.289783">{this.text2Sub}</text>
                <path ref={this.modeChangedPathRef} className="NormalStroke White" visibility="hidden" />
            </g>
        );
    }
}
...
class D3Cell extends DisplayComponent<{bus: ArincEventBus}> {
    ...
    render(): VNode {
        return (
            <text ref={this.textRef} className="FontSmallest MiddleAlign White" x="118.38384" y="21.104172" />
        );
    }
}
...
class E1Cell extends ShowForSecondsComponent<CellProps> {
    ...
    render(): VNode {
        return (
            <g>
                <path ref={this.modeChangedPathRef} visibility="hidden" className="NormalStroke White" d="m156.13 1.8143v6.0476h-20.81v-6.0476z" />
                <text className="FontMedium MiddleAlign White" x="145.61546" y="6.9559975">{this.textSub}</text>
            </g>
        );
    }
}
...
class E2Cell extends ShowForSecondsComponent<CellProps> {
    ...
    render(): VNode {
        return (
            <g>
                <path ref={this.modeChangedPathRef} d="m156.13 9.0715v6.0476h-20.81v-6.0476z" visibility="hidden" className="NormalStroke White" />
                <text className="FontMedium MiddleAlign White" x="145.95045" style="word-spacing: -1.9844px" y="14.417698">{this.textSub}</text>
...
class E3Cell extends ShowForSecondsComponent<CellProps> {
    ...
    render(): VNode {
        return (
            <g>
                <path ref={this.modeChangedPathRef} className="NormalStroke White" visibility="hidden" d="m135.32 16.329h20.81v6.0476h-20.81z" />
                <text className={this.classSub} x="145.75578" y={this.posSub}>A/THR</text>
            </g>
        );
    }
}